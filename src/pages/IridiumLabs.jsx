  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:image" content="https://lucaslucas.work/assets/iridium-labs/img-1.png" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            '@type': 'CreativeWork',
            name: 'Iridium Labs - Art Direction & Packaging',
            description: 'Art direction and packaging design for Iridium Labs, a Brazilian sports supplements brand spanning creatines, whey protein, thermogenics, and high-performance lines.',
            url: 'https://lucaslucas.work/iridium-labs',
            image: 'https://lucaslucas.work/assets/iridium-labs/img-1.png',
            datePublished: '2020',
